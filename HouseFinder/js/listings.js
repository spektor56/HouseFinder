                ...
                $.when(request1, request2).done(function() {
                    ...
                    if (locationPolygons.length > 0) {
                        ...
                        const testData = {
                            ...
                            Token: "D6TmfZprLI kLwBSrJwKfRQZFe3THLUDrAgTiVNVTME=",
                            GUID: "7932a734-598a-466e-b929-34f2a6366a1a",
                            Version: "6.0"
                        };
                        ...
                        $.ajax({
                            url: "http://api2.realtor.ca/Listing.svc/PropertySearch_Post",
                            type: "POST",
                            data: testData,
                            dataType: "json",
                            success: function(result) {
                        ...
                        cookieData +=
                            "PriceMin=300000&PriceMax=425000&BuildingTypeId=1&ConstructionStyleId=3&BedRange=0-0&BathRange=0-0&ParkingSpaceRange=0-0&viewState=m&Longitude=-80.30859375&Latitude=43.426769256591&PolygonPoints=";
